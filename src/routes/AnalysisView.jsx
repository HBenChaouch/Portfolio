    ...
    <div className="ff">
      <div className="ff-canvas" id="ff-canvas">
        <div className="ff-rows">
          <div className="ref fair" style={{ left: `calc(130px + 14px + ${pctFromValue(295)}% * (100% - 244px) / 100)` }} />
          <div className="ref-label fair" style={{ left: `calc(130px + 14px + ${pctFromValue(295)}% * (100% - 244px) / 100)` }}>Fair value €295m</div>
          ...
          <div className="ref market" style={{ left: `calc(130px + 14px + ${pctFromValue(237)}% * (100% - 244px) / 100)` }} />
          <div className="ref-label market" style={{ left: `calc(130px + 14px + ${pctFromValue(237)}% * (100% - 244px) / 100)` }}>Market ref. [placeholder]</div>
          {row("dcf", "DCF", "Fundamental", `${scenarioResults[activeScenario].ev.toFixed(0)}m`)}
          {row("trading", "Trading", "Stand-alone", "295m")}
          {row("transaction", "Transaction", "Control", "410m")}
          {row("lbo", "LBO", "Affordability", "283m")}
        </div>
      </div>
      <div className="ff-row ff-axis-row" aria-hidden="true">
        ...
        <div className="ff-axis-inner">
          ...
          <span className="tick tick-accent fair" style={{ left: "39%" }}>€295m</span>
  ...
  return (
    <article className="analysis-view">
      <header className="hero">
        ...
        <h1>Sidetrade fair value converges around <span className="accent">~€295m EV</span> stand-alone, ~€410m EV in a control case.</h1>
        <p className="sub">
        ...
        <div style={{ marginTop: 40, display: "grid", gridTemplateColumns: "1fr", gap: 20 }}>
          ...
          <div className="twoup">
            ...
            <div className="narrative" data-s={fcfView === "stat" ? "bear" : "base"} style={{ marginTop: 0 }}>
              ...
              <p>{fcfView === "stat" ? "Sidetrade’s 2025 transition to European mid-cap status triggered a 3-year deferral on the State’s CIR reimbursement. That creates a one-off €2.9m working-capital consumption weighing on 2025 FCF. Management itself communicates an operating cash flow of €8.7m \"excluding the timing impact of the Research Tax Credit\"." : "This view neutralises the CIR timing decalage to reflect the model’s recurring cash capacity. It is the preferred lens for the DCF, since the CIR effect is one-off and non-recurring."}</p>
            </div>
          </div>
        </div>
      ...
      <section className="block" id="market">
        ...
        <div className="market-card">
          <div className="meta-row"><span className="placeholder-flag">Placeholder</span><span>Market data as of <strong>[DATE — to be filled before publication]</strong></span></div>
          <div className="grid">
            <div className="cell"><div className="k">Current share price</div><div className="v">€[X]</div></div>
            <div className="cell"><div className="k">Market cap</div><div className="v">€[Y]m</div></div>
            <div className="cell"><div className="k">Implied EV</div><div className="v">€[Z]m</div></div>
            <div className="cell"><div className="k">Upside to fair value (€295m EV)</div><div className="v upside">+[A]%</div></div>
            <div className="cell"><div className="k">Upside to control case (€410m EV)</div><div className="v upside">+[B]%</div></div>
          </div>
          <p className="note">The dotted vertical line on the football field below mirrors the current market reference. Replace placeholders with last close + simple bridge (Market cap + net debt strict €14.7m = EV) before publishing.</p>
        </div>
      </section>
      ...
      <section className="block" id="dcf">
        ...
        <details className="method" id="methodology"><summary>How we built it · methodology</summary><div className="body"><p><strong>Starting point.</strong> EBITDA 2025 incl. CIR = €13.4m. We anchor here because (i) Sidetrade communicates in EBITDA incl. CIR, (ii) the CIR is a recurring cash item guaranteed by the French State — not an optional tax break.</p><p><strong>Core formula.</strong></p><pre>{`EBIT = EBITDA − D&A
FCF  = EBIT × (1 − tax) + D&A − Capex − ΔWC`}</pre><ol><li><strong>Economic vs accounting D&amp;A.</strong> Statutory shows ~€3.6m "amortization, depreciation and provisions" but that includes receivables provisions and operational provisions. Pure economic D&amp;A is ~€1.1m (intangibles €285k + tangibles €540k + goodwill/customer relations €296k). We use 2% of revenue as an economic proxy — not the 5.9% accounting figure.</li><li><strong>Normalised tax rate.</strong> 2025 P&amp;L shows +€2.15m net tax credit thanks to CIR. Theoretical reconcilable rate is ~17%. We spread by scenario: 25% Bear (progressive CIR erosion), 22% Base (stable regime), 20% Bull (international optimisation).</li><li><strong>WACC.</strong> Risk-free OAT 10Y ~3.2% + ERP Europe ~5.5% + small-cap SaaS relevered beta ~1.25 + size premium. Yields 8.5%–11.0% across scenarios.</li><li><strong>Terminal growth.</strong> 2.0%–3.0%, capped at 3% in Bull (above long-run European nominal GDP).</li><li><strong>Q1 2026 actuals.</strong> Already published at +17% reported / +21% cc total, +27% cc subscriptions — directly supports the Base case 17% 2026 growth assumption.</li></ol></div></details>
      ...
      <section className="block" id="trading">
        ...
        <table className="data">
          ...
          <tbody>
            ...
            <tr><td><Tip k="Finance automation" body="Closer to accounting workflow than O2C, but directly Office-of-CFO. Used as a mid-range anchor for SaaS premium multiples on a mature profile." v="FY+1 EV/Sales ~2.5–3.0x"><strong>BlackLine</strong></Tip></td><td>Finance automation · accounting workflow</td><td className="num">~2.5–3.0x</td><td>US</td></tr>
            <tr><td><Tip k="AP/AR + payments" body="Adjacent O2C in the SME US market — useful low-end anchor for AR automation multiples." v="FY+1 EV/Sales ~2.0x"><strong>BILL</strong></Tip></td><td>AP/AR automation + payments</td><td className="num">~2.0x</td><td>US</td></tr>
            <tr><td><Tip k="Vertical SaaS" body="Vertical banking SaaS — profitable, sticky, multi-year contracts. Adds vertical-SaaS premium reference." v="FY+1 EV/Sales ~3.0x"><strong>nCino</strong></Tip></td><td>Vertical SaaS banking</td><td className="num">~3.0x</td><td>US</td></tr>
            ...
            <tr><td><Tip k="CFO adjacency" body="Reporting / compliance SaaS — Office-of-CFO adjacency, not direct O2C." v="FY+1 EV/Sales ~3.0x"><strong>Workiva</strong></Tip></td><td>Reporting / compliance SaaS</td><td className="num">~3.0x</td><td>US</td></tr>
          </tbody>
        </table>
        <cite>Indicative ranges — to be refreshed before publication. Multiples are forward FY+1 to neutralise 2025 one-offs.</cite>
        <div className="twoup" style={{ marginTop: 32 }}>
          <div><h3>Retained multiples for Sidetrade</h3><table className="data" style={{ marginTop: 10 }}><thead><tr><th>Tier</th><th className="num">EV / Sales</th><th className="num">EV / EBITDA</th></tr></thead><tbody><tr><td className="label">Low — generalist SaaS peers</td><td className="num">3.0x</td><td className="num">15.0x</td></tr><tr><td className="label">Base — CFO-office premium peers</td><td className="num strong">5.0x</td><td className="num strong">22.0x</td></tr><tr><td className="label">High — AI-native vertical SaaS</td><td className="num">7.0x</td><td className="num">30.0x</td></tr></tbody></table></div>
          <div><h3>Range implied — stand-alone</h3><div className="result-strip three" style={{ marginTop: 10 }}><div className="cell"><div className="k">Low</div><div className="v">€185m</div><div className="d">EV implicit</div></div><div className="cell"><div className="k">Base</div><div className="v accent">€295m</div><div className="d">EV implicit</div></div><div className="cell"><div className="k">High</div><div className="v">€425m</div><div className="d">EV implicit</div></div></div><p style={{ fontSize: 13, color: "var(--ink-3)", marginTop: 14 }}>Convergence with DCF Base case at <strong style={{ color: "var(--bordeaux)" }}>~€295m EV</strong>. This convergence anchors the stand-alone central fair value.</p></div>
        </div>
      ...
      <section className="block" id="transaction">
        ...
        <div className="twoup" style={{ marginTop: 24 }}><div><h3>Sidetrade's own M&amp;A — internal benchmarks</h3><p style={{ fontSize: 13.5 }}><strong>ezyCollect (Oct 2025) ·</strong> Total consideration €37.6m (€34.8m cash + €2.6m stock). Contributed €2.241m revenue since 1 Oct 2025, i.e. ~€9m annualised run-rate → implicit multiple ~4.2x revenue run-rate. Lower-mid anchor: smaller, APAC, SME, lower gross margin — not directly comparable to Sidetrade's core but useful as a floor.</p><p style={{ fontSize: 13.5 }}><strong>SHS Viveon (2024) ·</strong> Special situation (delisting tender at €3.00/share). €4.4m revenue since July 2024 i.e. ~€8.8m annualised. Implicit multiple is very low and reflects forced delisting context — use as qualitative floor only.</p></div><div><h3>Retained multiples — forward 2026E</h3><p style={{ fontSize: 12, color: "var(--ink-3)" }}>Base 2026E from model: Revenue €71.9m · EBITDA €17.3m.</p><table className="data" style={{ marginTop: 8 }}><thead><tr><th>Tier</th><th className="num">EV / Sales</th><th className="num">EV / EBITDA</th><th className="num">EV impl.</th></tr></thead><tbody><tr><td className="label">Low</td><td className="num">3.8x</td><td className="num">18.0x</td><td className="num">€273–311m</td></tr><tr><td className="label">Base</td><td className="num strong">5.5x</td><td className="num strong">25.0x</td><td className="num strong">€395–431m</td></tr><tr><td className="label">High</td><td className="num">7.5x</td><td className="num">32.0x</td><td className="num">€539–552m</td></tr></tbody></table></div></div>
        <div className="result-strip three" style={{ marginTop: 18 }}><div className="cell"><div className="k">Low</div><div className="v">€290m</div><div className="d">EV implicit</div></div><div className="cell"><div className="k">Base · control</div><div className="v accent">€410m</div><div className="d">EV implicit</div></div><div className="cell"><div className="k">High</div><div className="v">€545m</div><div className="d">EV implicit</div></div></div>
      ...
      <section className="block" id="lbo">
        ...
        <div className="twoup"><div><h3>Base case assumptions</h3><table className="data" style={{ marginTop: 10 }}><tbody><tr><td className="label">Entry EV</td><td className="num strong">€295m</td></tr><tr><td className="label">EBITDA 2025</td><td className="num">€13.4m</td></tr><tr><td className="label">Acquisition debt (3.5x EBITDA)</td><td className="num">~€47m</td></tr><tr><td className="label">Sponsor equity</td><td className="num">~€248m</td></tr><tr><td className="label">Holding period</td><td className="num">5 years</td></tr><tr><td className="label">Interest rate</td><td className="num">~6.5%</td></tr><tr><td className="label">Cash sweep</td><td className="num">100% of levered FCF</td></tr><tr><td className="label">Exit EBITDA 2030 (Base)</td><td className="num">€36.2m</td></tr><tr><td className="label">Exit multiple (Base)</td><td className="num">~18.0x EBITDA</td></tr><tr className="total"><td>Target IRR (Base)</td><td className="num">~22.5%</td></tr></tbody></table><p style={{ fontSize: 12.5, color: "var(--ink-3)", marginTop: 12 }}><strong>On leverage:</strong> the existing covenant (Net debt / EBITDA &lt; 2.5x on the BNP/LCL loans tied to ezyCollect) does not constrain a future LBO — in a PE take-control, existing debt is refinanced inside a new package. The 3.5x reflects sensible LBO capacity for a profitable SaaS, not the current balance sheet.</p></div><div><h3>Range</h3><div className="result-strip three" style={{ marginTop: 10 }}><div className="cell"><div className="k">Low</div><div className="v">€135m</div><div className="d">IRR target 25%</div></div><div className="cell"><div className="k">Base</div><div className="v accent">€283m</div><div className="d">IRR target 22.5%</div></div><div className="cell"><div className="k">High</div><div className="v">€455m</div><div className="d">IRR target 18%</div></div></div><p style={{ fontSize: 13, color: "var(--ink-3)", marginTop: 14 }}>Low/High swing principally driven by IRR target (18% Low → 25% High) and exit multiple (15x → 22x). Convergence with DCF / trading comps in Base at ~€283m. Use as <strong>sponsor affordability test</strong>, not fundamental fair value.</p></div></div>
      ...
      <section className="block" id="football">
        ...
        <div className="grid-3" style={{ marginTop: 24 }}>
          <div className="card" style={{ borderTop: "3px solid var(--bordeaux)" }}><div className="mono-k" style={{ color: "var(--bordeaux)" }}>Stand-alone fair value</div><div className="big-card-value">€295m EV</div><p style={{ fontSize: 13, color: "var(--ink-2)", margin: 0 }}>Convergence of DCF + Trading Comps + LBO in Base case. The reference number.</p></div>
          ...
          <div className="card" style={{ borderTop: "3px solid var(--market)" }}><div className="mono-k" style={{ color: "var(--market)" }}>Implied share price · Base</div><div className="big-card-value">~€182</div><p style={{ fontSize: 13, color: "var(--ink-2)", margin: 0 }}>(€295m − €14.7m net debt) / 1.537m diluted shares = ~€182 / share.</p></div>
        </div>
        <div style={{ marginTop: 32 }}><h3>Bridge · EV → Equity → Share price</h3><WaterfallBridge activeScenario={activeScenario} /><p style={{ marginTop: 18, fontSize: 14, lineHeight: 1.6, color: "var(--ink-2)", maxWidth: 820 }}><strong>Stand-alone range:</strong> €185m – €425m EV → ~€110–€267 / share. <br /><strong>Extended range (incl. M&amp;A / LBO):</strong> €135m – €545m EV → ~€78–€345 / share.</p></div>
        <div style={{ marginTop: 32, padding: "28px 32px", background: "var(--bg-card)", border: "1px solid var(--line)", borderLeft: "4px solid var(--bordeaux)" }}><div className="mono-k" style={{ color: "var(--bordeaux)", marginBottom: 10 }}>Strategic read</div><p style={{ fontSize: 15.5, lineHeight: 1.6, color: "var(--ink)", margin: 0 }}>Sidetrade shows a clean financial profile: profitable O2C SaaS, dominant subscription mix (87%), premium subscription gross margin (92%), solid 22% EBITDA already, with operating leverage still ramping. The O2C Intelligence 2030 plan (30–35% EBITDA target) supports the DCF Base case trajectory.</p><p style={{ fontSize: 15.5, lineHeight: 1.6, color: "var(--ink)", margin: "14px 0 0" }}>Stand-alone central value <strong style={{ color: "var(--bordeaux)" }}>~€295m EV</strong> places Sidetrade in a defensible zone around €180–190 / share. The control case <strong style={{ color: "var(--bull)" }}>~€410m EV</strong> reflects a real M&amp;A optionality — ideal target profile for a European strategic consolidator or a mid-market PE sponsor, in line with the Esker / Bridgepoint–General Atlantic precedent.</p><p style={{ fontSize: 13.5, lineHeight: 1.55, color: "var(--ink-3)", fontStyle: "italic", margin: "18px 0 0", maxWidth: 820 }}>Sidetrade's stand-alone fair value converges around ~€295m EV, supported by DCF, trading comps and LBO affordability. Transaction precedents suggest a control valuation closer to ~€410m EV, reflecting strategic scarcity in Office-of-CFO / Order-to-Cash software.</p></div>
      </section>
