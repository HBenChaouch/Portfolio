export const SOURCE_STATUS = Object.freeze({
  CANONICAL_WORKBOOK: "Canonical workbook · reconciled",
  PUBLIC_DISCLOSURE: "Public disclosure · reported",
  INTERNAL_ESTIMATE: "Internally reviewed estimate · confirm in data room",
  ENGINE_DERIVED: "Audited engine · calculated",
...
export const SOURCES = Object.freeze({
  ...
  market: {
    ...
    status: SOURCE_STATUS.MARKET_MANUAL,
  },
  qoe: {
...
// Published page conventions are frozen separately from exact workbook values.
// They preserve the audited S5 display while calculations continue to use exacts.
...
export const QOE = Object.freeze({
  ...
  adjustedEbitdaExCir: 10.7,
  adjustedEbitdaInclCir: 14.2,
...
export const VALUATION_CONTEXT = Object.freeze({
  ...
  transactionRange: Object.freeze({ low: 289, base: 411, high: 547 }),
